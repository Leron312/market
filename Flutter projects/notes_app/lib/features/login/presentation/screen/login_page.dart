        ...
        listener: (context, state) {
          if (state.isSuccessfullySignedIn) {
            if (state.isNotesListEmpty) {
              ...
              showDialog(context: context, builder: (context) => const _SaveLocalDataDialog());
              // context.pop();
            }
          }
        },
    ...
    return AlertDialog(
      ...
      actions: [
        TextButton(
          ...
          onPressed: () {
            context.read<LoginBloc>().add(LoginSaveLocalDataYesButtonClicked());
          },
        ),
        TextButton(
